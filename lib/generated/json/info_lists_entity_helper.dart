...
infoListsEntityFromJson(InfoListsEntity data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = new InfoListsData().fromJson(json['data']);
	}
...
Map<String, dynamic> infoListsEntityToJson(InfoListsEntity entity) {
...
infoListsDataFromJson(InfoListsData data, Map<String, dynamic> json) {
	if (json['curPage'] != null) {
		data.curPage = json['curPage']?.toInt();
	}
	if (json['datas'] != null) {
		data.datas = new List<InfoListsDataData>();
		(json['datas'] as List).forEach((v) {
			data.datas.add(new InfoListsDataData().fromJson(v));
		});
	}
	if (json['offset'] != null) {
...
Map<String, dynamic> infoListsDataToJson(InfoListsData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
infoListsDataDataFromJson(InfoListsDataData data, Map<String, dynamic> json) {
...
Map<String, dynamic> infoListsDataDataToJson(InfoListsDataData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
